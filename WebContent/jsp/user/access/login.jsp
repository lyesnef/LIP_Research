...
<body>
    <jsp:include page="/jsp/common/menu_bar/user_menu.jsp" />
		<form id="login" method="post" action="Login.action">
		    <h1>로 그 인</h1>
		    <fieldset id="inputs">
		        <input id="username" name="username" type="text" placeholder="아이디를 입력해 주세요" autofocus required>   
		        <input id="password" name="password" type="password" placeholder="비밀번호를 입력해 주세요" required>
		    </fieldset>
		     ${message}
		    <fieldset id="actions">
		        <input type="submit" id="submit" value="로 그 인" >
		       <a href="/LIP_Research/jsp/user/join/regForm.jsp">회원가입</a>
		    </fieldset>
