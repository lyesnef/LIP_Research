 ...
 html
{
    height: 100%;
 	 ...
 	 background: url(/LIP_Research/images/common/bg-pattern.png) center;
}
...
function focusPW(){
	var pwId = document.getElementById("password");
	pwId.focus();
}
</script>
</head>
...
<body onload="focusPW()">
    ...
    <div id="body-section">
		<form id="login" method="post" action="CheckPW.action">
		    <h1>정보확인</h1>
		    <fieldset id="inputs">
		        <input id="password" name="password" type="password" placeholder="비밀번호를 입력해 주세요" required>
		        <p align="center">
		        	<font color="red">${fieldErrors.fail}</font>
		        </p>
		    </fieldset>
		    <fieldset id="actions">
		        <input type="submit" id="submit" value="확 인" onclick="logIn()">
		    </fieldset>
		    <a href="http://localhost/LIP_Research/" id="back">메인으로 돌아가기</a>
		</form>
	</div>
	<br/>
	<br/>
