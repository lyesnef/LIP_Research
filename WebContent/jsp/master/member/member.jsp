...
{
    document.myform.action="/LIP_Research/master/member/SendEmail.action?usage=3";
    document.myform.submit();
}
</script>
</head>
...
<body>
            ...
            <table border=1>
                ...
                <s:iterator value="lipmemberList">
			        <tr>
			            ...
			            <td  align="center"><s:property value="memberEmail" />
			             <input type="hidden" name="userEmail" value="<s:property value="memberEmail" />">
			             <input type="hidden" name="userid" value="<s:property value="memberId" />">
			            </td>
    ...
    <%-- <input type="hidden" id="userEmail" name="userEmail" value="<s:property value="memberEmail" />"> --%>
    </div>
