...
<jsp:include page="/jsp/common/menu_bar/user_menu.jsp" />
	...
	<div id="body-section"> 
	<form action="ModifyQna.action" method="post" name="myForm">
		<div>
		...
		<input type="text" size="84" value="<s:property value="qna.qnaTitle"/>" placeholder="Q&A 제목을 입력하세요" name="qna.qnaTitle">
		</div>
		<div>
			<textarea id="qnaContant" placeholder="Q&A 내용을 입력하세요" name="qna.qnaContant">
				<s:property value="qna.qnaContant"/>
			</textarea>
		</div>
		<div class="pagefind">
		<div  class="btn_area_r01">
			<a href="#Reg" onclick="javascript:document.myForm.submit()">수정</a>
